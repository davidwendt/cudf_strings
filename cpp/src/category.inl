...
// the inline technique here allows splitting specializations across multiple .cu files
// this actually speeds up compile time because each file can be compiled in parallel
