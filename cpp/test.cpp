...
void testcat( const T* data1, const T* data2 )
{
    ...
    custr::category<T>* gatcat = cat.gather( gatidxs, 6 );
    gatcat->print(" ");
    delete gatcat;
...
void testnulls( const T* data1, const T* data2 )
{
    ...
    custr::category<T> cat( data1, 9, g_nulls1 );
    ...
    custr::category<T>* addcat = cat.add_keys( data2, 4, g_nulls2 );
    addcat->print(" ");
    ...
    custr::category<T>* rmvcat = cat.remove_keys( data2+2, 2, g_nulls3 );
    rmvcat->print(" ");
    delete rmvcat;
    ...
    custr::category<T>* setcat = cat.set_keys( data2, 4, g_nulls3 );
    setcat->print(" ");
    delete setcat;
    ...
    // merge
    std::cout << " merge ";
    custr::category<T> twocat( data2, 4, g_nulls3 );
    twocat.print(" ");
    custr::category<T>* mrgcat = cat.merge(twocat);
    mrgcat->print(" ");
    delete mrgcat;
