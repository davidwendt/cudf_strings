...
#include "../include/string_view.cuh"


// nvcc -w -std=c++14 --expt-relaxed-constexpr --expt-extended-lambda -gencode arch=compute_70,code=sm_70 test_string_view.cu -I/usr/local/cuda/include  -I../../../cudf/cpp/include -o test_string_view
